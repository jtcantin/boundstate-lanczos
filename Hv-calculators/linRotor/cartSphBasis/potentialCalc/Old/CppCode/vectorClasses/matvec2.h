...
/* Original class made by Dr. Pierre-Nicholas Roy
 Modified by Joshua Tyler Cantin (JTC) as follows on:
 13 May 2013
 -Replaced depreciated <*.h> libraries.
 -Added Fortran naming convention for MAC OS X (__APPLE__ && __MACH__)
 -Sz and TheVector made public in vector class
 -Added header guard
 -Added vector() constructor
 -Added setCoor function
 -Added setSz function
 -Added eNorm function
 15 May 2013
 -Coded overloaded () operator for the matrix class
 */
...
// class hermmatrix;
class vector {
public: // Sz and TheVector made public by JTC
	int Sz;
	double* TheVector;
...
//public:
	...
	void setCoor(double* new_coor); //Added by JTC
	void setSz(int dim); //Added by JTC
